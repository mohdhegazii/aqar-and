...
class Aqarand_Districts_List_Table extends WP_List_Table {
                ...
                <div class="form-field">
                    ...
                    <select name="city_id" id="city_id" required>
                        <?php foreach ($cities as $city): ?>
                            <option value="<?php echo $city->id; ?>"><?php echo $city->name_ar; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <?php
        ...
        <div class="form-wrap">
            ...
            <form method="post">
                ...
                <div class="form-field">
                    ...
                    <select name="city_id" id="city_id" required>
                        <?php foreach ($cities as $city): ?>
                            <option value="<?php echo $city->id; ?>" <?php selected($item['city_id'], $city->id); ?>>
                                <?php echo $city->name_ar; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
