...
function jawda_project_features_register_cron_schedule($schedules) {
    if (!isset($schedules['jawda_ten_minutes'])) {
        $schedules['jawda_ten_minutes'] = [
            ...
            'display'  => __('Every 10 minutes', 'aqarand'),
        ];
    }
...
function jawda_project_features_generate_term_map() {
    ...
    foreach ($terms as $term) {
        ...
        if (isset($group_cache[$group_key])) {
            ...
            $data = [
                'name_ar'            => $name_ar ? $name_ar : $name_en,
...
function jawda_project_features_seed_upsert(array $record, &$inserted_flag = null) {
    ...
    $name_ar = isset($record['name_ar']) ? trim((string) $record['name_ar']) : '';
...
function jawda_project_features_seed_defaults($force = false) {
    ...
    $finishing_types = [
        [
            'name_ar'            => 'بدون تشطيب (على الطوب الأحمر)',
        ...
        [
            'name_ar'            => 'نصف تشطيب (على المحارة أو الأساسيات)',
    ...
    $lookup_defaults = [
        ['name_ar' => 'إطلالة على اللاندسكيب', 'name_en' => 'Landscape View', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'إطلالة على البحيرة', 'name_en' => 'Lake View', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'سقف مرتفع', 'name_en' => 'High Ceiling', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'واجهة زجاجية بالكامل', 'name_en' => 'Full Glass Façade', 'relation' => 'مشروع / وحدة', 'category' => 'Feature'],
        ['name_ar' => 'نظام سمارت هوم', 'name_en' => 'Smart Home System', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'مدخل فندقي', 'name_en' => 'Hotel-like Entrance', 'relation' => 'مشروع', 'category' => 'Feature'],
        ['name_ar' => 'إضاءة طبيعية واسعة', 'name_en' => 'Natural Light Spaces', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'تصميم معماري عصري', 'name_en' => 'Modern Architectural Design', 'relation' => 'مشروع', 'category' => 'Feature'],
        ['name_ar' => 'كلوب هاوس', 'name_en' => 'Clubhouse', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'جيم وساونا وسبا', 'name_en' => 'Gym, Sauna & Spa', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'حمام سباحة إنفينيتي', 'name_en' => 'Infinity Pool', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'ممشى للجري', 'name_en' => 'Jogging Track', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'منطقة ألعاب أطفال', 'name_en' => 'Kids Play Area', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'منطقة شواء', 'name_en' => 'BBQ Area', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'سينما خاصة', 'name_en' => 'Private Cinema', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'كافيهات ومطاعم', 'name_en' => 'Cafés & Restaurants', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'Roof Lounge', 'name_en' => 'Rooftop Lounge', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'مساحات خضراء واسعة', 'name_en' => 'Wide Green Areas', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'أمن وحراسة 24 ساعة', 'name_en' => '24/7 Security', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'نظام كاميرات مراقبة', 'name_en' => 'CCTV Surveillance', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'مصاعد كهربائية حديثة', 'name_en' => 'Modern Elevators', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'جراج تحت الأرض', 'name_en' => 'Underground Parking', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'مولّد كهرباء احتياطي', 'name_en' => 'Backup Generator', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'نظام مكافحة حريق', 'name_en' => 'Fire Fighting System', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'استقبال واستعلامات', 'name_en' => 'Reception & Concierge', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'خدمة تنظيف وصيانة', 'name_en' => 'Cleaning & Maintenance Service', 'relation' => 'مشروع / وحدة', 'category' => 'Facility'],
        ['name_ar' => 'إنترنت فائق السرعة', 'name_en' => 'High-speed Internet', 'relation' => 'مشروع / وحدة', 'category' => 'Facility'],
        ['name_ar' => 'محطة شحن سيارات كهربائية', 'name_en' => 'EV Charging Station', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'مولد مياه احتياطي', 'name_en' => 'Water Backup Tank', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'مسجد أو مصلى', 'name_en' => 'Mosque / Prayer Area', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'هايبر ماركت', 'name_en' => 'Supermarket', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'منطقة إدارية', 'name_en' => 'Administrative Area', 'relation' => 'مشروع', 'category' => 'Feature'],
        ['name_ar' => 'منطقة طبية', 'name_en' => 'Medical Area', 'relation' => 'مشروع', 'category' => 'Feature'],
        ['name_ar' => 'مداخل منفصلة للوحدات', 'name_en' => 'Separate Entrances', 'relation' => 'مشروع', 'category' => 'Feature'],
        ['name_ar' => 'نظام تكييف مركزي', 'name_en' => 'Central AC System', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'نظام إطفاء ذكي', 'name_en' => 'Smart Fire Detection', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'كاميرات داخلية للوحدة', 'name_en' => 'Internal Security Cameras', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'خدمات إدارة تأجير', 'name_en' => 'Rental Management Service', 'relation' => 'مشروع', 'category' => 'Facility'],
        ['name_ar' => 'مسارات للدراجات', 'name_en' => 'Cycling Paths', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'فندق أو خدمات فندقية', 'name_en' => 'Hotel / Serviced Units', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'عيادات وصيدليات', 'name_en' => 'Clinics & Pharmacy', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'مول تجاري داخلي', 'name_en' => 'Indoor Mall', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'منطقة ترفيه ليلي', 'name_en' => 'Entertainment Zone', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'صالة متعددة الاستخدام', 'name_en' => 'Multipurpose Hall', 'relation' => 'مشروع', 'category' => 'Amenity'],
        ['name_ar' => 'حديقة خاصة', 'name_en' => 'Private Garden', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'تراس واسع', 'name_en' => 'Large Terrace', 'relation' => 'وحدة', 'category' => 'Feature'],
        ['name_ar' => 'لوكيشن استراتيجي', 'name_en' => 'Prime Location', 'relation' => 'مشروع', 'category' => 'Feature'],
    ];

    $view_defaults = [
        ['name_ar' => 'على شارع رئيسي', 'name_en' => 'Main Road View'],
        ['name_ar' => 'على شارع داخلي', 'name_en' => 'Internal Street View'],
        ['name_ar' => 'على ميدان', 'name_en' => 'Square View'],
        ['name_ar' => 'على محور / طريق سريع', 'name_en' => 'Highway / Main Axis View'],
        ['name_ar' => 'على مدخل المشروع', 'name_en' => 'Project Entrance View'],
        ['name_ar' => 'على حدائق / لاندسكيب', 'name_en' => 'Gardens / Landscape View'],
        ['name_ar' => 'على بارك مركزي', 'name_en' => 'Central Park View'],
        ['name_ar' => 'على بحيرة صناعية', 'name_en' => 'Artificial Lake View'],
        ['name_ar' => 'على حمام السباحة', 'name_en' => 'Pool View'],
        ['name_ar' => 'على النادي / الكلوب هاوس', 'name_en' => 'Clubhouse / Club View'],
        ['name_ar' => 'على منطقة أطفال', 'name_en' => 'Kids Area View'],
        ['name_ar' => 'على منطقة تجارية (محلات)', 'name_en' => 'Retail / Commercial Strip View'],
        ['name_ar' => 'على الجراج / الباركينج', 'name_en' => 'Parking View'],
        ['name_ar' => 'على فناء داخلي (كورتيارد)', 'name_en' => 'Courtyard / Internal Garden View'],
        ['name_ar' => 'على واجهات مباني أخرى', 'name_en' => 'Other Buildings View'],
        ['name_ar' => 'على سور المشروع', 'name_en' => 'Compound Wall View'],
        ['name_ar' => 'على مدرسة / جامعة', 'name_en' => 'School / University View'],
        ['name_ar' => 'على منطقة خدمية (محطة، خدمات)', 'name_en' => 'Service Area View'],
        ['name_ar' => 'فيو مفتوح / بانوراما', 'name_en' => 'Open / Panoramic View'],
        ['name_ar' => 'بدون فيو مميز (منور / حارة خلفية)', 'name_en' => 'Light Well / Back Alley View'],
    ];

    $orientation_defaults = [
        ['name_ar' => 'بحري (شمالي)', 'name_en' => 'North / Bahary'],
        ['name_ar' => 'قبلي (جنوبي)', 'name_en' => 'South / Qebly'],
        ['name_ar' => 'شرقي', 'name_en' => 'East'],
        ['name_ar' => 'غربي', 'name_en' => 'West'],
        ['name_ar' => 'بحري شرقي', 'name_en' => 'North-East (Bahary Sharqy)'],
        ['name_ar' => 'بحري غربي', 'name_en' => 'North-West (Bahary Gharby)'],
        ['name_ar' => 'قبلي شرقي', 'name_en' => 'South-East (Qebly Sharqy)'],
        ['name_ar' => 'قبلي غربي', 'name_en' => 'South-West (Qebly Gharby)'],
        ['name_ar' => 'متعددة الاتجاهات', 'name_en' => 'Multiple Orientations'],
    ];

    $facade_defaults = [
        ['name_ar' => 'واجهة واحدة', 'name_en' => 'Single Facade'],
        ['name_ar' => 'واجهتين ناصية', 'name_en' => 'Corner Unit (Two Facades)'],
        ['name_ar' => 'ثلاث واجهات', 'name_en' => 'Three Facades (Head of Block)'],
        ['name_ar' => 'أربع واجهات / مستقلة', 'name_en' => 'Detached (Four Facades)'],
        ['name_ar' => 'بدون جيران جانبيين', 'name_en' => 'No Side Neighbors'],
        ['name_ar' => 'بدون جار علوي', 'name_en' => 'No Upper Neighbor (Top Floor)'],
        ['name_ar' => 'بدون جار سفلي', 'name_en' => 'No Lower Neighbor (Ground / Over Podium)'],
        ['name_ar' => 'بدون جيران (مستقلة بالكامل)', 'name_en' => 'Fully Detached / No Neighbors'],
    ];

    $marketing_orientation_defaults = [
        [
            'name_ar'        => 'واجهة واحدة بحري',
    ...
    foreach ($lookup_defaults as $item) {
        ...
        jawda_project_features_seed_upsert([
            'name_ar'            => isset($item['name_ar']) ? $item['name_ar'] : '',
    ...
    foreach ($orientation_defaults as $item) {
        ...
        if ($id) {
            $orientation_map[jawda_project_features_seed_normalize_key($item['name_ar'])] = $id;
    ...
    foreach ($facade_defaults as $item) {
        ...
        if ($id) {
            $facade_map[jawda_project_features_seed_normalize_key($item['name_ar'])] = $id;
