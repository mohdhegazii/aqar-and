(function ($) {
    ...
    var config = window.aqarandPaymentPlans || {};
    ...
    var planFieldSelector = '.carbon-fields__field[data-name="_aqarand_payment_plans"]';
    var planContainerSelector = planFieldSelector + ' .carbon-fields__complex-group';

    function fieldSelector(key) {
        return '[name^="carbon_fields_compact_input"][name*="[_aqarand_payment_plans]"][name$="[' + key + ']"]';
    }
